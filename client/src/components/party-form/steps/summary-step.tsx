...
export function SummaryStep({
  ...
  const calculateTotal = () => {
    ...
    const addonTotal = (formData.partyAddons || []).reduce(
    ...
    <div className="text-center">
      <div className="mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-3">
          Perfect! Let's review everything
        </h2>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                ...
                {formatTime(formData.partyTime)}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Theme:</span>
              <span className="font-medium">
                {THEME_LABELS[formData.partyTheme] || formData.partyTheme}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Birthday Star:</span>
              <span className="font-medium">
                {formData.childName}, Turning {formData.childAge}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Guest Count:</span>
              <span className="font-medium">
                {formData.guestCount} children
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Food:</span>
              <span className="font-medium">
                {formData.foodChoice === "pizza" ? "Pizza" : "Bagels"} &{" "}
                {formData.cupcakeFlavor === "vanilla" ? "Vanilla" : "Chocolate"}{" "}
                Cupcakes
              </span>
            </div>
          </div>
              ...
              <div className="space-y-2 text-sm">
                {formData.partyAddons.map((addon: string) => (
                  <div key={addon} className="flex justify-between">
                    ...
                    <span className="font-medium pricing-font">
          ...
          <div className="pt-4 border-t border-gray-100">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-xl text-coral pricing-font">
                ${totalPrice}
              </span>
            </div>
            <p className="text-xs text-gray-500 mt-1">
              <span className="pricing-font">$200</span> deposit required •
      ...
      <Alert className="mb-6 border-yellow-200 bg-yellow-50">
        ...
        <AlertDescription className="text-left">
          ...
          <p className="text-sm text-yellow-700">
            By submitting this booking, you agree to our terms & conditions and
            understand that a <span className="pricing-font">$200</span>{" "}
            non-refundable deposit is required to secure your date.
          </p>
        </AlertDescription>
      </Alert>
