        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Party Designer Tool</h1>
                <p className="text-sm text-gray-600">Design your perfect celebration</p>
              </div>
            </div>
            <Link href="/">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {eventTypes.map((eventType) => (
            <Card 
              key={eventType.id}
              className="group cursor-pointer border-2 border-transparent hover:border-purple-300 hover:shadow-xl transition-all transform hover:scale-105"
              onClick={() => setSelectedEventType(eventType.id)}
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${eventType.gradient} opacity-5 rounded-lg`}></div>
              ...
              <CardContent className="relative z-10 pt-0">
                ...
                <div className="mt-6 text-center">
                  <Button 
                    className={`bg-gradient-to-r ${eventType.gradient} text-white hover:opacity-90 w-full group-hover:shadow-lg transition-all`}
                  >
                    Start Planning
                  </Button>
                </div>
