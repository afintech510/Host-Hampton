            ...
            <CardContent className="space-y-6">
              <section>
                ...
                <div className="space-y-2 text-gray-700">
                  <p>
                    • A $200 deposit is required to secure your party
                    reservation
                  </p>
                  <p>
                    • Deposits are fully refundable up to 48 hours before your
                    scheduled event
                  </p>
                  <p>• The remaining balance is due on the day of your event</p>
                  <p>• All prices are subject to 8.75% sales tax</p>
                  <p>
                    • Additional guests beyond the base package are charged at
                    $25 per person
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-2 text-gray-700">
                  <p>
                    • Cancellations made 48+ hours before event: Full deposit
                    refund
                  </p>
                  <p>
                    • Cancellations made 24-48 hours before: 50% deposit refund
                  </p>
              ...
              <section>
                <h3 className="text-lg font-semibold mb-3">
                  3. Party Modifications
                </h3>
                <div className="space-y-2 text-gray-700">
                  <p>
                    • Guest count changes must be confirmed 24 hours prior to
                    event
                  </p>
                  <p>
                    • Add-on services can be modified up to 24 hours before your
                    party
                  </p>
              ...
              <section>
                ...
                <div className="space-y-2 text-gray-700">
                  <p>• Host Hampton is located in Speonk, NY</p>
                  <p>
                    • Adult supervision is required at all times during
                    children's parties
                  </p>
                  <p>
                    • Outside food and beverages may be restricted based on
                    package selection
                  </p>
              ...
              <section>
                ...
                <div className="space-y-2 text-gray-700">
                  <p>
                    • Parents/guardians are responsible for supervising children
                    throughout the event
                  </p>
                  <p>
                    • Host Hampton provides general liability coverage for the
                    facility
                  </p>
                  <p>• Guests participate in activities at their own risk</p>
                  <p>
                    • Any damages to facility or equipment will be charged to
                    the booking party
                  </p>
                  <p>
              ...
              <section>
                <h3 className="text-lg font-semibold mb-3">
                  6. Food Service and Allergies
                </h3>
                <div className="space-y-2 text-gray-700">
                  <p>
                    • Please inform us of any food allergies or dietary
                    restrictions in advance
                  </p>
                  <p>
                    • We accommodate gluten-free, dairy-free, and other special
                    dietary needs when possible
                  </p>
                  <p>
                    • Food safety is our priority - outside food may be
                    restricted
                  </p>
                  <p>
                    • Birthday cakes and cupcakes are included in most packages
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-2 text-gray-700">
                  ...
                  <p>• Address: Host Hampton, Speonk, NY</p>
              ...
              <section className="bg-purple-50 p-4 rounded-lg">
                ...
                <p className="text-gray-700">
                  By booking a party with Host Hampton, you acknowledge that you
                  have read, understood, and agree to these terms and
                  conditions. These terms are subject to change and will be
                  updated on our website accordingly.
                </p>
